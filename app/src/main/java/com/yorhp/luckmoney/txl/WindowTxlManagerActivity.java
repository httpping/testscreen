package com.yorhp.luckmoney.txl;
 ...
 * 聊天窗口
 */
public class WindowTxlManagerActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        aSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked){
                    ...
                    WindowTxlController.getInstance().destroyThumbWindow();
                }
            }
        });
    ...
    public void start_window(View view) {
        ...
        //开启悬浮窗
        WindowTxlController.getInstance().showThumbWindow(this);
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 100) {
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        WxScanAccessibilityService.mService.isStartTxl = true;
                        WxScanAccessibilityService.mService.scan_type = txl;
                        wxUsers = WxScanAccessibilityService.mService.scanTxl(ACTION_SCROLL_FORWARD);
            ...
            if (msg.what == 1001){
                ...
                for (WxUser wxUser:wxUsers){
                    stringBuffer.append("用户："+wxUser.name+" 账户："+wxUser.user +" 性别："+ wxUser.sex +"\n");
                }
