...
public class WindowTxlController implements View.OnTouchListener {

    @SuppressLint("StaticFieldLeak")
    private static WindowTxlController instance;
    ...
    private WindowTxlController() {
        this.mContext = MyApplication.getApplication();
    }

    public static WindowTxlController getInstance() {
        if (instance == null) {
            synchronized (WindowTxlController.class) {
                if (instance == null) {
                    instance = new WindowTxlController();
                }
            }
        }
        return instance;
